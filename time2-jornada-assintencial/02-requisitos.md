...
|:---|:---|:---|:---|
| RF001 | Filtros Multidimensionais | Filtragem por unidade, especialidade, tipo de evento, período e status | Essencial |
| RF002 | Painel de KPIs | Calcular e exibir os KPIs assistenciais e operacionais parametrizados por filtro | Essencial |
| RF003 | Identificação de Gargalos | Ranquear etapas da jornada por tempo médio de espera e destacar as críticas | Essencial |
| RF004 | Análise de Fluxos Predominantes | Agrupar e exibir sequências de eventos por frequência e proporção | Alta |
| RF005 | Painel de Prontuários Inertes | Identificar prontuários sem eventos subsequentes e exibir volume e percentual | Alta |
| RF006 | Pipeline de Extração de Dados | Processo automatizado de extração das 7 views do AGHU e carga no banco local | Essencial |
...
| KPI-08 | Proporção de encaminhamentos por tipo | `COUNT(por_tipo) / COUNT(total)` | Consultas |
| KPI-09 | Ranking de gargalos por tempo de espera | `AVG(tempo_espera) DESC por categoria` | Exames, Internações |
...
### [CARE-RF004] Análise de Fluxos Predominantes
...
### [CARE-RF005] Painel de Prontuários Inertes
...
### [CARE-RF006] Pipeline de Extração de Dados
